"""adaptive_feature_fusion_networks URL Configuration
...
from adaptive_feature_fusion_networks import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Passenger_Flow_Type/$', remoteuser.Predict_Passenger_Flow_Type, name="Predict_Passenger_Flow_Type"),
    ...
    url(r'^View_Predicted_Passenger_Flow_Type_Ratio/$', serviceprovider.View_Predicted_Passenger_Flow_Type_Ratio, name="View_Predicted_Passenger_Flow_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Passenger_Flow_Type/$', serviceprovider.View_Predicted_Passenger_Flow_Type, name="View_Predicted_Passenger_Flow_Type"),
