...
ROOT_URLCONF = 'adaptive_feature_fusion_networks.urls'
...
WSGI_APPLICATION = 'adaptive_feature_fusion_networks.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'adaptive_feature_fusion_networks',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
